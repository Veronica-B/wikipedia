    ...
    <React.Fragment>
        <section className="ver-container">
            ...
            <div className="ver-slogo-container"></div>
                ...
                <h3>SECTION BODY:</h3>
                <input type="text" class="ver-text-field section-bdy-field" placeholder="Sephora is a French multinational chain of personal care and beauty stores. Featuring nearly 3,000 brands,
